...
@if ($notes->count() == 0)
  <div class="row">
    <div class="col-md text-center">
      <h5>No current notes - <a href="{{route('notes.create', ['id'=> $id])}}">Add One</a></h5>
  '  </div>
  </div>
@else
  ...
  <div class="row">         
    <div class="col-md text-secondary text-truncate">
      <a href='{{url('/notes/'.$note->id);}}'><i class="fas fa-sticky-note"></i> {!! $note->content !!}</a>
    </div>
...
<div class="row">
  <div class="col-md-2 mx-auto">
    <a href='{{ route('notes.create', ['id' => $id]) }}' class='btn btn-info btn-sm'><i class="fas fa-plus"></i> Create Note</a>
  </div>
</div>